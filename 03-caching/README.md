...
| 27 | Your cache contains stale user information. How would you maintain consistency? | [27-stale-user-data.md](27-stale-user-data.md) | — | not-started |
| 28 | Design a distributed cache across multiple regions. | [28-multi-region-cache.md](28-multi-region-cache.md) | — | not-started |
| 29 | How would you handle hot keys in Redis? | [29-hot-keys.md](29-hot-keys.md) | — | not-started |
| 30 | Design a semantic cache for an LLM application. | [30-semantic-cache-llm.md](30-semantic-cache-llm.md) | — | not-started |
